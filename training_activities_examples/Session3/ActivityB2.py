...
class TestCalculateBMI(unittest.TestCase):
    ...
    def test_height_must_be_within_the_accepted_range(self):
        self.assertEqual(CalculateBMI(1.35, 45), "Height must be between 139.7 cm and 243.8 cm")
        self.assertEqual(CalculateBMI(2.55, 45), "Height must be between 139.7 cm and 243.8 cm")
